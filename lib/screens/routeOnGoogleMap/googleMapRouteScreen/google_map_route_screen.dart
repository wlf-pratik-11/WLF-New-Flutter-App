...
import 'package:wlf_new_flutter_app/screens/routeOnGoogleMap/googleMapRouteScreen/google_map_route_screen_bloc.dart';
...
class GoogleMapRouteScreen extends StatefulWidget {
  ...
  const GoogleMapRouteScreen({super.key, this.savedAddressDl, this.fromSavedAddress});

  @override
  State<GoogleMapRouteScreen> createState() => _GoogleMapRouteScreenState();
}

class _GoogleMapRouteScreenState extends State<GoogleMapRouteScreen> {
  late GoogleMapRouteScreenBloc _bloc;
  List<Predictions> suggestedAddress = [];
  late LatLng savedAddressLatlng;
  @override
  void didChangeDependencies() {
    _bloc = GoogleMapRouteScreenBloc(context, widget.fromSavedAddress, widget.savedAddressDl);
